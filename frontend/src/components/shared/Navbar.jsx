                ...
                {activeModalTab === 'login' && (
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <a
                        href={`${import.meta.env.VITE_API_URL || 'https://sessionly-2weo.onrender.com'}/api/social/login/google-oauth2/`}
                      ...
                      <a href={`${import.meta.env.VITE_API_URL || 'https://sessionly-2weo.onrender.com'}/api/social/login/github/`}
